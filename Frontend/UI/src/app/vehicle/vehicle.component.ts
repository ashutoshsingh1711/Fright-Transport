...
export class VehicleComponent implements OnInit {
  ...
  getAll() {
    this.vehicleservice
      .getVehicle()
      .subscribe((data: any) => (this.vehicleDetails = data));
    this.submitted = true;
    this.getting = true;
  }
  update() {
  ...
  getIdmessage(v: any) {
    ...
    this.vehicleservice
      .getVehicleByVehicleNumber(v)
      .subscribe((data: any) => this.vehicleDetails.push(data));
  }
